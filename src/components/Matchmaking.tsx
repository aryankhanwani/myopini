      ...
      <div className="min-h-screen bg-background p-4 sm:p-6 flex items-center justify-center">
        <div className="w-full max-w-lg space-y-4 sm:space-y-6">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl sm:text-3xl font-heading font-bold text-win">
              Opponent Found!
            </h1>
            <p className="text-sm sm:text-base text-muted">Preparing for battle...</p>
          </div>
            ...
            <CardContent className="p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
                <Avatar className="h-12 w-12 sm:h-16 sm:w-16 border-2 border-primary">
                  <AvatarFallback className="bg-gradient-primary text-white font-bold text-lg sm:text-xl">
                    {opponent.avatar}
                  </AvatarFallback>
                </Avatar>
                ...
                <div className="flex-1 space-y-2 text-center sm:text-left">
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-2">
                    <h3 className="text-lg sm:text-xl font-heading font-bold text-card-foreground">
                      {opponent.name}
                    </h3>
                    {opponent.isBot && (
                  ...
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-2 sm:gap-4 text-xs sm:text-sm">
                    <div className="flex items-center gap-1">
                      <Trophy className="h-3 w-3 sm:h-4 sm:w-4 text-win" />
