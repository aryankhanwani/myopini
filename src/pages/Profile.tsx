      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="flex items-center justify-between mb-6 sm:mb-8">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-heading font-bold text-foreground">Profile</h1>
              <p className="text-sm sm:text-base text-muted">Your crypto quiz journey</p>
            </div>
          </div>
        </div>

        {/* Profile Header */}
        <Card className="bg-card border-card-border mb-6 sm:mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
              ...
              <div className="flex-1 text-center sm:text-left">
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-2 sm:gap-3 mb-2">
                  <h2 className="text-xl sm:text-2xl font-heading font-bold text-foreground">{userProfile.username}</h2>
                ...
                <div className="flex items-center justify-center sm:justify-start gap-4 sm:gap-6 text-xs sm:text-sm">
                  <div>
                    <div className="text-base sm:text-lg font-score font-bold text-foreground">#{userProfile.rank}</div>
                    <div className="text-muted">Rank</div>
                  </div>
                  <div>
                    <div className="text-base sm:text-lg font-score font-bold text-win">{userProfile.totalScore.toLocaleString()}</div>
                    <div className="text-muted">Total Score</div>
                  </div>
                  <div>
                    <div className="text-base sm:text-lg font-score font-bold text-primary">Level {userProfile.level}</div>
