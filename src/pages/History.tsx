    ...
    <div className="min-h-screen bg-[#0a0f1c] text-slate-200 antialiased">
      <div className="flex min-h-screen">
        ...
        <div className="flex items-center justify-between mb-6 sm:mb-8">
          <div>
            <h1 className="text-2xl sm:text-3xl font-heading font-bold text-foreground">Match History</h1>
            <p className="text-sm sm:text-base text-muted">Your competitive journey</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
          <Card className="bg-card border-card-border">
            <CardContent className="p-3 sm:p-4 text-center">
              <div className="text-xl sm:text-2xl font-score font-bold text-win mb-1">{stats.wins}</div>
